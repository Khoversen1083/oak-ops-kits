---
name: welcome-email
description: Use this to send welcome email sequence to new clients. Use when user asks to send welcome emails, onboard new client with emails, or trigger welcome sequence.
---
...
## Scripts
- `~/.claude/skills/welcome-email/scripts/welcome_client_emails.py` - Send welcome sequence
...
```bash
python3 ~/.claude/skills/welcome-email/scripts/welcome_client_emails.py \
