...
1. **Step 0, Setup Interview.** Check for `intake-filled.md`. If
   ...
   answers, confirm.
2. **Step 1, calibration or selection.** Read the kit's first
   resource file, show the student the rules or criteria, calibrate
   or pick.
...
- Can be run in 30 to 90 minutes for the first time
